document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_value: "We bring the rich textile heritage of Asia and Africa to Sweden. Discover authentic, handpicked traditional garments—saris, kaftans, dashikis and more—delivered to your door at fair prices with no unnecessary markups. Founded by a team with roots in Pakistan, Afghanistan, the Middle East and Africa, we offer more than clothes: representation, pride, and a piece of home. Wear your culture every day or on special occasions—genuine and accessible.",
        ...
        sv: {
            ...
            hero_value: "Vi för det rika textilarvet från Asien och Afrika till Sverige. Upptäck autentiska, handplockade traditionella plagg – saris, kaftaner, dashikis och mer – levererade till din dörr till rättvisa priser utan onödiga pålägg. Grundat av ett team med rötter i Pakistan, Afghanistan, Mellanöstern och Afrika erbjuder vi mer än bara kläder: representation, stolthet och en bit av hemmet. Bär din kultur varje dag eller vid speciella tillfällen – äkta och tillgängligt.",
