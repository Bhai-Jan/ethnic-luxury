document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_value: "We bring authentic Asian and African textile heritage to Sweden. Handpicked traditional garments—saris, kaftans, dashikis and more—delivered at fair prices, no extra markups. Founded by people with roots in Pakistan, Afghanistan, the Middle East and Africa, we offer more than clothing: pride, representation, and a piece of home. Genuine cultural wear made accessible—for everyday life or special moments.",
            hero_cta: "Explore the Collection",
            usp_title: "What Makes Us Different",
            usp_authentic_title: "Curated Authenticity",
            usp_authentic_desc: "Every piece is hand-selected with deep cultural knowledge from Pakistan, Afghanistan, the Middle East, and Africa. We ensure authenticity and relevance—not generic imports.",
            usp_accessible_title: "Accessible Authenticity",
            usp_accessible_desc: "Traditional fashion is often hard to find in Sweden. We make it simple and affordable through direct dropshipping from trusted suppliers—no middleman markups.",
            usp_unique_title: "Beyond Fast Fashion",
            usp_unique_desc: "Timeless styles that last. We blend tradition with modern wear, choose quality pieces, and produce on-demand to minimize waste and keep prices fair.",
            ...
            audience_text1: "Ethnic Luxury is for women and men in Sweden with roots in Asia and Africa. We make authentic cultural clothing—representing your identity—easy to find and wear.",
            audience_text2: "Founded by people from Pakistan, Afghanistan, the Middle East, and Africa, we understand the challenge of finding traditional fashion in Scandinavia. More than a store, we build cultural pride and belonging.",
            ...
            sustain_text_1: "Our direct-to-consumer dropshipping model means no overproduction or big warehouses. Items are made and shipped only after you order—reducing waste while keeping authentic African and Asian clothing affordable and responsible.",
            sustain_text_2: "",
            ...
            cta_text: "Get exclusive access to new arrivals, cultural style inspiration, and 15% off your first purchase.",
            btn_join: "Join Now",
        ...
        sv: {
            ...
            hero_value: "Vi för autentiskt asiatiskt och afrikanskt textilarv till Sverige. Handplockade traditionella plagg – saris, kaftaner, dashikis och mer – levererade till rättvisa priser, utan extra påslag. Grundat av människor med rötter i Pakistan, Afghanistan, Mellanöstern och Afrika erbjuder vi mer än bara kläder: stolthet, representation och en bit av hemmet. Äkta kulturellt mode gjort tillgängligt – för vardagen eller speciella stunder.",
            hero_cta: "Utforska Kollektionen",
            usp_title: "Vad Gör Oss Unika",
            usp_authentic_title: "Utvald Autenticitet",
            usp_authentic_desc: "Varje plagg är handplockat med djup kulturell kunskap från Pakistan, Afghanistan, Mellanöstern och Afrika. Vi garanterar autenticitet och relevans – inga generiska importer.",
            usp_accessible_title: "Tillgänglig Autenticitet",
            usp_accessible_desc: "Traditionellt mode är ofta svårt att hitta i Sverige. Vi gör det enkelt och prisvärt genom direkt dropshipping från pålitliga leverantörer – inga påslag från mellanhänder.",
            usp_unique_title: "Bortom Fast Fashion",
            usp_unique_desc: "Tidlösa stilar som håller. Vi blandar tradition med modernt mode, väljer kvalitetsplagg och producerar på begäran för att minimera avfall och hålla priserna rättvisa.",
            ...
            audience_text1: "Ethnic Luxury är för kvinnor och män i Sverige med rötter i Asien och Afrika. Vi gör autentiska kulturella kläder – som representerar din identitet – lätta att hitta och bära.",
            audience_text2: "Grundat av människor från Pakistan, Afghanistan, Mellanöstern och Afrika förstår vi utmaningen att hitta traditionellt mode i Skandinavien. Mer än en butik, vi bygger kulturell stolthet och tillhörighet.",
            ...
            sustain_text_1: "Vår direkt-till-konsument dropshipping-modell innebär ingen överproduktion eller stora lager. Varor tillverkas och skickas först efter din beställning – vilket minskar avfall samtidigt som vi håller autentiska afrikanska och asiatiska kläder prisvärda och ansvarsfulla.",
            sustain_text_2: "",
            ...
            cta_text: "Få exklusiv tillgång till nyheter, kulturell stiltips och 15% rabatt på ditt första köp.",
            btn_join: "Gå Med Nu",
